    ...
    public static class LanguageManager
    {
            ...
            new Dictionary<Language, Dictionary<string, string>>
        {
            [Language.zh_CN] = new Dictionary<string, string>
            {
                ...
                ["emptyCategory"] = "（空）",
                ["mdImport"] = "从 Markdown 导入",
                ["mdImportScreentip"] = "导入 Markdown 表格",
                ["mdImportSupertip"] = "从 Markdown 文件或剪贴板解析表格，选中后写入新工作表。",
                ["mdImportFile"] = "从文件导入",
                ["mdImportClipboard"] = "从剪贴板导入",
                ["mdImportSelect"] = "选择要导入的表格：",
                ["mdImportNoTable"] = "未找到 Markdown 表格。",
                ["mdImportClipboardEmpty"] = "剪贴板中没有可导入的文本。",
                ["mdImportDone"] = "已导入 {0} 个表格。",
                ["mdImportFailed"] = "Markdown 导入失败",
                ["mdImportTable"] = "表",
            },
            [Language.zh_TW] = new Dictionary<string, string>
            {
                ...
                ["emptyCategory"] = "（空）",
                ["mdImport"] = "從 Markdown 匯入",
                ["mdImportScreentip"] = "匯入 Markdown 表格",
                ["mdImportSupertip"] = "從 Markdown 檔案或剪貼簿解析表格，選取後寫入新工作表。",
                ["mdImportFile"] = "從檔案匯入",
                ["mdImportClipboard"] = "從剪貼簿匯入",
                ["mdImportSelect"] = "選擇要匯入的表格：",
                ["mdImportNoTable"] = "找不到 Markdown 表格。",
                ["mdImportClipboardEmpty"] = "剪貼簿中沒有可匯入的文字。",
                ["mdImportDone"] = "已匯入 {0} 個表格。",
                ["mdImportFailed"] = "Markdown 匯入失敗",
                ["mdImportTable"] = "表",
            },
            [Language.en] = new Dictionary<string, string>
            {
                ...
                ["emptyCategory"] = "(empty)",
                ["mdImport"] = "Import Markdown",
                ["mdImportScreentip"] = "Import Markdown tables",
                ["mdImportSupertip"] = "Parse tables from a Markdown file or the clipboard, then write selected ones to new worksheets.",
                ["mdImportFile"] = "Import from file",
                ["mdImportClipboard"] = "Import from clipboard",
                ["mdImportSelect"] = "Select tables to import:",
                ["mdImportNoTable"] = "No Markdown table found.",
                ["mdImportClipboardEmpty"] = "No importable text on the clipboard.",
                ["mdImportDone"] = "Imported {0} table(s).",
                ["mdImportFailed"] = "Markdown import failed",
                ["mdImportTable"] = "Table",
            },
            [Language.de] = new Dictionary<string, string>
            {
                ...
                ["emptyCategory"] = "(leer)",
                ["mdImport"] = "Markdown importieren",
                ["mdImportScreentip"] = "Markdown-Tabellen importieren",
                ["mdImportSupertip"] = "Tabellen aus einer Markdown-Datei oder der Zwischenablage parsen und ausgewählte in neue Arbeitsblätter schreiben.",
                ["mdImportFile"] = "Aus Datei importieren",
                ["mdImportClipboard"] = "Aus Zwischenablage importieren",
                ["mdImportSelect"] = "Zu importierende Tabellen wählen:",
                ["mdImportNoTable"] = "Keine Markdown-Tabelle gefunden.",
                ["mdImportClipboardEmpty"] = "Kein importierbarer Text in der Zwischenablage.",
                ["mdImportDone"] = "{0} Tabelle(n) importiert.",
                ["mdImportFailed"] = "Markdown-Import fehlgeschlagen",
                ["mdImportTable"] = "Tabelle",
},
            [Language.fr] = new Dictionary<string, string>
            {
                ...
                ["emptyCategory"] = "(vide)",
                ["mdImport"] = "Importer Markdown",
                ["mdImportScreentip"] = "Importer les tableaux Markdown",
                ["mdImportSupertip"] = "Analyser les tableaux depuis un fichier Markdown ou le presse-papiers, puis écrire ceux sélectionnés dans de nouvelles feuilles.",
                ["mdImportFile"] = "Importer depuis un fichier",
                ["mdImportClipboard"] = "Importer depuis le presse-papiers",
                ["mdImportSelect"] = "Choisir les tableaux à importer :",
                ["mdImportNoTable"] = "Aucun tableau Markdown trouvé.",
                ["mdImportClipboardEmpty"] = "Aucun texte importable dans le presse-papiers.",
                ["mdImportDone"] = "{0} tableau(x) importé(s).",
                ["mdImportFailed"] = "Échec de l'importation Markdown",
                ["mdImportTable"] = "Tableau",
},
            [Language.ru] = new Dictionary<string, string>
            {
                ...
                ["emptyCategory"] = "(пусто)",
                ["mdImport"] = "Импорт Markdown",
                ["mdImportScreentip"] = "Импорт таблиц Markdown",
                ["mdImportSupertip"] = "Разобрать таблицы из файла Markdown или буфера обмена и записать выбранные на новые листы.",
                ["mdImportFile"] = "Импорт из файла",
                ["mdImportClipboard"] = "Импорт из буфера обмена",
                ["mdImportSelect"] = "Выберите таблицы для импорта:",
                ["mdImportNoTable"] = "Таблица Markdown не найдена.",
                ["mdImportClipboardEmpty"] = "Нет импортируемого текста в буфере обмена.",
                ["mdImportDone"] = "Импортировано таблиц: {0}.",
                ["mdImportFailed"] = "Ошибка импорта Markdown",
                ["mdImportTable"] = "Таблица",
},
            [Language.vi] = new Dictionary<string, string>
            {
                ...
                ["emptyCategory"] = "(trống)",
                ["mdImport"] = "Nhập Markdown",
                ["mdImportScreentip"] = "Nhập bảng Markdown",
                ["mdImportSupertip"] = "Phân tích bảng từ tệp Markdown hoặc clipboard, sau đó ghi các bảng đã chọn sang sheet mới.",
                ["mdImportFile"] = "Nhập từ tệp",
                ["mdImportClipboard"] = "Nhập từ clipboard",
                ["mdImportSelect"] = "Chọn bảng cần nhập:",
                ["mdImportNoTable"] = "Không tìm thấy bảng Markdown.",
                ["mdImportClipboardEmpty"] = "Không có văn bản nào để nhập trong clipboard.",
                ["mdImportDone"] = "Đã nhập {0} bảng.",
                ["mdImportFailed"] = "Nhập Markdown thất bại",
                ["mdImportTable"] = "Bảng",
},
            [Language.th] = new Dictionary<string, string>
            {
                ...
                ["emptyCategory"] = "(ว่าง)",
                ["mdImport"] = "นำเข้า Markdown",
                ["mdImportScreentip"] = "นำเข้าตาราง Markdown",
                ["mdImportSupertip"] = "แยกวิเคราะห์ตารางจากไฟล์ Markdown หรือคลิปบอร์ด จากนั้นเขียนตารางที่เลือกไปยังแผ่นงานใหม่",
                ["mdImportFile"] = "นำเข้าจากไฟล์",
                ["mdImportClipboard"] = "นำเข้าจากคลิปบอร์ด",
                ["mdImportSelect"] = "เลือกตารางที่จะนำเข้า:",
                ["mdImportNoTable"] = "ไม่พบตาราง Markdown",
                ["mdImportClipboardEmpty"] = "ไม่มีข้อความที่นำเข้าได้ในคลิปบอร์ด",
                ["mdImportDone"] = "นำเข้า {0} ตารางแล้ว",
                ["mdImportFailed"] = "การนำเข้า Markdown ล้มเหลว",
                ["mdImportTable"] = "ตาราง",
},
            [Language.id] = new Dictionary<string, string>
            {
                ...
                ["mdImport"] = "Impor Markdown",
                ["mdImportScreentip"] = "Impor tabel Markdown",
                ["mdImportSupertip"] = "Mengurai tabel dari file Markdown atau clipboard, lalu menulis tabel yang dipilih ke lembar kerja baru.",
                ["mdImportFile"] = "Impor dari file",
                ["mdImportClipboard"] = "Impor dari clipboard",
                ["mdImportSelect"] = "Pilih tabel untuk diimpor:",
                ["mdImportNoTable"] = "Tidak ditemukan tabel Markdown.",
                ["mdImportClipboardEmpty"] = "Tidak ada teks yang dapat diimpor di clipboard.",
                ["mdImportDone"] = "{0} tabel diimpor.",
                ["mdImportFailed"] = "Impor Markdown gagal",
                ["mdImportTable"] = "Tabel",
},
            [Language.bo] = new Dictionary<string, string>
            {
                ...
                ["mdImport"] = "Markdown ནང་འཛུལ།",
                ["mdImportScreentip"] = "Markdown རེའུ་མིག་ནང་འཛུལ།",
                ["mdImportSupertip"] = "Markdown ཡིག་ཆ་དང་མཐུན་སྒྲིག་ནས་རེའུ་མིག་བཤེར་ཏེ་བྱང་བུ་གསར་པར་འཇུག།",
                ["mdImportFile"] = "ཡིག་ཆ་ནས་ནང་འཛུལ།",
                ["mdImportClipboard"] = "མཐུན་སྒྲིག་ནས་ནང་འཛུལ།",
                ["mdImportSelect"] = "ནང་འཛུལ་བྱེད་རྒྱུའི་རེའུ་མིག་འདེམས།",
                ["mdImportNoTable"] = "Markdown རེའུ་མིག་མི་འདུག",
                ["mdImportClipboardEmpty"] = "མཐུན་སྒྲིག་ནང་ཡིག་གཞི་མེད།",
                ["mdImportDone"] = "རེའུ་མིག་{0} ནང་འཛུལ་བྱས་ཟིན།",
                ["mdImportFailed"] = "Markdown ནང་འཛུལ་ལས་འཆར་མ་བྱུང་།",
                ["mdImportTable"] = "རེའུ་མིག",
},
            [Language.ug] = new Dictionary<string, string>
            {
                ...
                ["splitByColumnFiltered"] = "",
                ["emptyCategory"] = "（بوش）",
                ["mdImport"] = "Markdown ئەكىرىش",
                ["mdImportScreentip"] = "Markdown جەدۋىلىنى ئەكىرىش",
                ["mdImportSupertip"] = "Markdown ھۆججەت ياكى كۆچۈرمە تاختىدىكى جەدۋەللەرنى پارسىلاپ، تاللانغانلىرىنى يېڭى ۋاراققا يېزىش.",
                ["mdImportFile"] = "ھۆججەتتىن ئەكىرىش",
                ["mdImportClipboard"] = "كۆچۈرمە تاختىدىن ئەكىرىش",
                ["mdImportSelect"] = "ئەكىرىدىغان جەدۋەللەرنى تاللاڭ:",
                ["mdImportNoTable"] = "Markdown جەدۋىلى تېپىلمىدى.",
                ["mdImportClipboardEmpty"] = "كۆچۈرمە تاختىدا ئەكىرىدىغان تېكىست يوق.",
                ["mdImportDone"] = "{0} جەدۋەل ئەكىرىلدى.",
                ["mdImportFailed"] = "Markdown ئەكىرىش مەغلۇپ بولدى",
                ["mdImportTable"] = "جەدۋەل",
},
            [Language.ja] = new Dictionary<string, string>
            {
                ...
                ["emptyCategory"] = "（空）",
                ["mdImport"] = "Markdown をインポート",
                ["mdImportScreentip"] = "Markdown テーブルをインポート",
                ["mdImportSupertip"] = "Markdown ファイルまたはクリップボードからテーブルを解析し、選択したものを新しいシートに書き込みます。",
                ["mdImportFile"] = "ファイルからインポート",
                ["mdImportClipboard"] = "クリップボードからインポート",
                ["mdImportSelect"] = "インポートするテーブルを選択:",
                ["mdImportNoTable"] = "Markdown テーブルが見つかりません。",
                ["mdImportClipboardEmpty"] = "クリップボードにインポート可能なテキストがありません。",
                ["mdImportDone"] = "{0} 個のテーブルをインポートしました。",
                ["mdImportFailed"] = "Markdown インポートに失敗しました",
                ["mdImportTable"] = "表",
},
        };
